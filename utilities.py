...
def my_task2_binary_predictions(task3_model, par_emb, par_textf, lgb_flag=False):
    """Utility function for producing binary predictions before producing multi-label predictions on task 3.
    This function is called prior to 'task3_authorship_predictions'.
...
def my_task2_final_authorship_predictions(task3_binary_preds, par_emb, par_textf, random_baseline=False):
