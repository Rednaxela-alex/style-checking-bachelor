...
def load_documents(folder_path):
    ...
    elif folder_path == 'input_dir_dataset1':
        folder_path = TEST_FOLDER_DATASET1
    elif folder_path == 'input_dir_dataset2':
        folder_path = TEST_FOLDER_DATASET2
    elif folder_path == 'input_dir_dataset3':
        folder_path = TEST_FOLDER_DATASET3
...
def my_task2_final_authorship_predictions(task2_binary_preds, par_emb, par_textf, random_baseline=False):
