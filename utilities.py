...
TRAIN_FOLDER_DATASET1 = "./input_dir/data/dataset1/train/"
VAL_FOLDER_DATASET1 = "./input_dir/data/dataset1/validation/"
TRAIN_FOLDER_DATASET2 = "./input_dir/data/dataset2/train/"
VAL_FOLDER_DATASET2 = "./input_dir/data/dataset2/validation/"
TRAIN_FOLDER_DATASET3 = "./input_dir/data/dataset3/train/"
VAL_FOLDER_DATASET3 = "./input_dir/data/dataset3/validation/"

DOC_EMB_TRAIN_FOR_TASK1 = './features/dataset1/doc_emb_train.pickle'
DOC_EMB_VAL_FOR_TASK1 = './features/dataset1/doc_emb_val.pickle'
DOC_TEXTF_TRAIN_FOR_TASK1 = './features/dataset1/doc_textf_train.pickle'
DOC_TEXTF_VAL_FOR_TASK1 = './features/dataset1/doc_textf_val.pickle'
...
def task1_load_cases(feature, shuffle=False, seed=0):
    ...
    if feature == "emb":
        path_train = DOC_EMB_TRAIN_FOR_TASK1
        path_val = DOC_EMB_VAL_FOR_TASK1
    elif feature == "textf":
        path_train = DOC_TEXTF_TRAIN_FOR_TASK1
        path_val = DOC_TEXTF_VAL_FOR_TASK1
    else:
        raise ValueError
...
def task3_parchange_predictions(task2_model, par_emb, par_textf):
...
def task2_binary_predictions(task1_preds_prob, task3_model, par_emb, par_textf, lgb_flag=False):
    """Utility function for producing binary predictions before producing multi-label predictions on task 3.
    This function is called prior to 'task3_authorship_predictions'.
...
def task2_authorship_predictions(task1_preds_prob, task3_binary_preds, par_emb, par_textf, random_baseline=False):
